...
const Signup = () => {
  ...
  return (
    <>
        <div className="w-full mt-32 max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
            <div className="px-6 py-4">
                ...
                <p className="mt-1 text-center text-gray-500 dark:text-gray-400">Let’s begin setting up your profile.</p>

                
                    <div className="w-full mt-4">
                        <input onChange={e => {
                            setFirstName(e.target.value);
                        }} className="block w-full px-4 py-2 mt-2 text-white placeholder-gray-500 bg-white border rounded-lg dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-opacity-40 focus:outline-none focus:ring focus:ring-blue-300" type="text" placeholder="firstname" aria-label="firstname" />
                    </div>
                    <div className="w-full mt-4">
                        <input onChange={e => {
                            setLastName(e.target.value);
                        }} className="block w-full px-4 py-2 mt-2 text-white placeholder-gray-500 bg-white border rounded-lg dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-opacity-40 focus:outline-none focus:ring focus:ring-blue-300" type="text" placeholder="lastname" aria-label="lastname" />
                    </div>
                    <div className="w-full mt-4">
                        <input onChange={e => {
